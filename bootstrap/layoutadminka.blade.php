...
@section('styles')
    <!-- DataTables CSS -->
        ...
        <link rel="stylesheet" href="/lara/public/script/pyramid/css/structure/infragistics.css">
        <link rel="stylesheet" href="/lara/public/script/pyramid/css/themes/infragistics/infragistics.theme.css">
        ...
        <script type="text/javascript" src="/lara/public/script/bootstrapvalidator/src/js/language/ru_RU.js"></script>
        ...
        <script type="text/javascript" src="/lara/public/script/pyramid/infragistics.js"></script>

        <script src="/lara/public/script/pyramid/highcharts.js"></script>
        <script src="/lara/public/script/pyramid/funnel.js"></script>
